                    ...
                    {step === 1 && (
                        <div className="space-y-5 animate-fade-up">
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 py-3.5 px-4 bg-white border-2 border-stone-200 rounded-xl text-stone-700 font-medium hover:bg-stone-50 hover:border-stone-300 transition-all duration-200"
                            >
                            ...
                            <div className="relative my-2">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-4 bg-stone-50 text-stone-500">or sign up with email</span>
                                </div>
                            </div>
